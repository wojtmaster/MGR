...
u_ucz_stat = F_1(1:2:end-1) - F_10;
u_wer_stat = F_1(2:2:end) - F_10;
y_ucz_stat = h_2(1:2:end-1) - h_20;
y_wer_stat = h_2(2:2:end) - h_20;

%% Fuzzy static charaacteristic - Hammerstein
[R_hammerstein, hammerstein_params] = static_characteristic_y_u(u, u_ucz_stat, u_wer_stat, y_ucz_stat, y_wer_stat, u_start, u_end, n, 'linear');
